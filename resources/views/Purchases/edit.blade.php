...
<div class="row">
	...
	<form method="post" action="{{ action('PurchaseController@update',$purchase['id']) }}">
		...
		<label style="float: right; font-size: 20px;">اسم المُشترى</label><input type="text" name="resource_name" class="form-control" value="{{ $purchase['resource_name']}}">
		</div>
		<div class="form-group">
		<label style="float: right; font-size: 20px; ">تاريه الشراء</label><input type="date" name="purchase_date" class="form-control" value="{{ $purchase['purchase_date']}}">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
		<label style="float: right; font-size: 20px;">المكتب</label><input type="text" name="officer" class="form-control"  value="{{ $purchase['officer']}}"> 
		</div>
