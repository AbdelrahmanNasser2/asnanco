...
<div class="row">
	<div class="col-md-12">
		...
		@endif
		<form method="post" action="{{ action('SalaryController@update', $Salary['id']) }}">
			{{csrf_field()}}
			{{method_field('PATCH')}}
			...
			<div class="form-group">
				...
				required=""  style="text-align:right;" value="{{ $Salary['emp_name'] }}">
			</div>
			
			<div class="form-group">
				<label style="float:right; font-size: 20px;">تاريخ تسليم المرتب</label>
				<input type="date" name="delivery_date" class="form-control" placeholder="تاريخ تسليم المرتب" 
				required="" value="{{ $Salary['delivery_date'] }}">
			</div>

			<div class="form-group">
				<label style="float:right; font-size: 20px;">عدد أيام الشغل</label>
				<input type="number" name="work_days" id="work_days" min="0" class="form-control" placeholder="عدد أيام الشغل" 
				required=""  style="text-align:right;" value="{{ $Salary['work_days'] }}">
			</div>

			<div class="form-group">
				<label style="float:right; font-size: 20px;">عدد أيام الغياب</label>
				<input type="number" name="absence_days" id="absence_days" min="0" class="form-control" placeholder="عدد أيام الغياب" 
				required="" style="text-align:right;" value="{{ $Salary['absence_days'] }}">
			</div>

			<div class="form-group">
				<label style="float:right; font-size: 20px;">عدد أيام التأخير</label>
				<input type="nmuber" name="delay_days" id="delay_days" min="0" class="form-control" placeholder="عدد أيام التأخير" 
				required="" style="text-align:right;" value="{{ $Salary['delay_days'] }}">
			</div>

			<div class="form-group">
				<label style="float:right; font-size: 20px;">المرتب</label>
				<input type="number" name="salary" id="salary" min="0" class="form-control" placeholder="المرتب" 
				required="" style="text-align:right;" value="{{ $Salary['salary'] }}">
			</div>
			<div class="form-group">
				<label style="float:right; font-size: 20px;">قيمة الخصومات</label>
				<input type="number" name="discount1" disabled id="discount1" class="form-control" placeholder="قيمة الخصومات" 
				style="text-align:right;" value="{{ $Salary['discount'] }}">
				<input type="hidden" name="discount" id="discount"  value="{{ $Salary['discount'] }}"/>
			</div>
			<div class="form-group">
				<label style="float: right; font-size: 20px;">صافى المرتب</label>
				<input type="number" name="net_salary1" disabled id="net_salary1" class="form-control" placeholder="صافى المرتب" 
				style="text-align:right;" value="{{ $Salary['net_salary'] }}">
